...
exports.UnologinNextJS = void 0;
const cookies_1 = __importDefault(require("cookies"));
const http_handlers_1 = __importDefault(require("@unologin/node-sdk/http-handlers"));
const node_sdk_1 = __importDefault(require("@unologin/node-sdk"));
const errors_1 = require("@unologin/node-sdk/errors");
/**
 * API handlers and utility functions for server-side Next.js.
 */
class UnologinNextJS extends http_handlers_1.default {
    /**
     *
     * @param client client
     */
    constructor(client = node_sdk_1.default) {
        super(client);
        this.rest = node_sdk_1.default.rest;
        /**
...
exports.UnologinNextJS = UnologinNextJS;
exports.default = UnologinNextJS;
